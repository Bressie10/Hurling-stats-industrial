...
- Apply release-required Supabase SQL with `npm run supabase:migration:release-required` when `SUPABASE_DB_URL` is set, or paste the three SQL files into Supabase in this order: `20260617_team_scoped_data_and_rls.sql`, `20260617_team_scoped_policy_reset.sql`, then `20260618_free_match_quota.sql`.
